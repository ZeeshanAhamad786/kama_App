...
class CenterPatientNameAdmin extends StatefulWidget {
  CenterPatientNameAdmin({Key? key, required this.centerName1})
      : super(key: key);
  String centerName1;
  @override
  State<CenterPatientNameAdmin> createState() => _CenterPatientNameAdminState();
}

class _CenterPatientNameAdminState extends State<CenterPatientNameAdmin> {
      ...
      body: Padding(
        ...
        child: Column(children: [
          ...
          Expanded(
              child: StreamBuilder(
            stream:
                patientPersonalDetailsController.userPatientData.snapshots(),
                ...
                return ListView.builder(
                    ...
                    itemBuilder: (BuildContext context, int index) {
                      ...
                      return GestureDetector(
                        ...
                        child:widget.centerName1==snapshot.data.docs[index]["centerName"]?  Padding(
