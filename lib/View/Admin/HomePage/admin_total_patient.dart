...
class TotalPatientsAdmin extends StatefulWidget {
  const TotalPatientsAdmin({Key? key}) : super(key: key);

  @override
  State<TotalPatientsAdmin> createState() => _TotalPatientsAdminState();
}

class _TotalPatientsAdminState extends State<TotalPatientsAdmin> {
