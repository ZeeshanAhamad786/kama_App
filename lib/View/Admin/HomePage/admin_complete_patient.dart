...
class AdminCompletePatient extends StatefulWidget {
  const AdminCompletePatient({Key? key}) : super(key: key);

  @override
  State<AdminCompletePatient> createState() => _AdminCompletePatientState();
}

class _AdminCompletePatientState extends State<AdminCompletePatient> {
