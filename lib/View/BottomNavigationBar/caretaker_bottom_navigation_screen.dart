...
import 'package:kama_app/View/CaretakerScreens/caretaker_center_patient_name.dart';
import 'package:kama_app/View/CaretakerScreens/caretaker_home_screen.dart';
import 'package:kama_app/View/CaretakerScreens/caretaker_refer_screen.dart';
import 'package:kama_app/View/CaretakerScreens/caretaker_setting_screen.dart';
...
class _CaretakerBottomNavigationScreenState
  ...
  static List<Widget> widgetOptions = <Widget>[
    ...
    const CaretakerAlertScreen(),
    const CaretakerReferScreen(),
    const CaretakerCenterPatientName(),
    const CaretakerSettingScreen(),
  ];
