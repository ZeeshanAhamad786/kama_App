...
import 'package:kama_app/View/Supervisor/reset_password_supervisor.dart';
...
class OtpScreenSupervisor extends StatefulWidget {
  const OtpScreenSupervisor({Key? key}) : super(key: key);
  @override
              ...
              CustomElevatedButton(
                  ...
                  onPressed: () {
                    Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => const ResetScreenSupervisor()));
                  }),
              SizedBox(
