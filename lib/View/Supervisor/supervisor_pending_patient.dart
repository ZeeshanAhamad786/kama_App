...
class SupervisorPendingPatient extends StatefulWidget {
  const SupervisorPendingPatient({Key? key}) : super(key: key);

  @override
  State<SupervisorPendingPatient> createState() => _SupervisorPendingPatientState();
}

class _SupervisorPendingPatientState extends State<SupervisorPendingPatient> {
      ...
      body: Padding(
        ...
        child: Column(children: [
          Expanded(child: StreamBuilder(
            stream: patientPersonalDetailsController.userPatientData.where("status",isEqualTo: "pending") .snapshots(),
