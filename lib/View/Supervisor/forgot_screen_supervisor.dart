...
import 'package:kama_app/View/Supervisor/otp_screen_supervisor.dart';
import 'package:responsive_sizer/responsive_sizer.dart';
import '../../../Utils/Colors/Colors.dart';
import '../../../Utils/Constant/Constant.dart';
import '../Widgets/custom_button.dart';

class ForgotScreenSupervisor extends StatelessWidget {
                  ...
                  children: [
                    ...
                    Center(
                      child: CustomElevatedButton(buttonText: ("Next"),buttonColor: CustomColors.mainAppColor,
                          onPressed: (){
                            Navigator.push(context, MaterialPageRoute(builder: (_)=>OtpScreenSupervisor()));
                          }),
                    ),
