...
class SupervisorTotalPatient extends StatefulWidget {
  const SupervisorTotalPatient({Key? key}) : super(key: key);

  @override
  State<SupervisorTotalPatient> createState() => _SupervisorTotalPatientState();
}

class _SupervisorTotalPatientState extends State<SupervisorTotalPatient> {
