...
class CompletePatient extends StatefulWidget {
  const CompletePatient({Key? key}) : super(key: key);

  @override
  State<CompletePatient> createState() => _CompletePatientState();
}

class _CompletePatientState extends State<CompletePatient> {
