...
class CaretakerPersonalDetailsTab extends StatefulWidget {
  const CaretakerPersonalDetailsTab({Key? key}) : super(key: key);

  @override
  State<CaretakerPersonalDetailsTab> createState() => _CaretakerPersonalDetailsTabState();
}

class _CaretakerPersonalDetailsTabState extends State<CaretakerPersonalDetailsTab> {
  final TextEditingController messageControllerTab1 =TextEditingController();
                                ...
                                children: [
                                  Expanded(
                                    child: TextFormField(
                                        ...
                                        controller: messageControllerTab1,
                                        style:
                                        TextStyle(
                                            fontSize:
                                            13.px),
                                  ...
                                  InkWell(
                                    onTap: () {
                                      chatList.add(messageControllerTab1.text);messageControllerTab1.clear();
                                    },
                                    child: Container(
                                      decoration: BoxDecoration(
                                          color: const Color(
